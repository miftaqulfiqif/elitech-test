...
@section('content')
    <div class="flex flex-col w-full px-2 md:px-10 lg:px-20 bg-slate-900 text-white gap-10">
                ...
                <div class="flex flex-row  gap-4 items-center justify-between">
                    ...
                    <a href="#" id="menu" class="block md:hidden relative">
                        ...
                        <div id="menu-content"
                            ...
                            <a href="#" class="hover:bg-slate-700 bg-slate-900 px-4 py-2 rounded-lg">Edit Profile</a>
                            <a href="#" class="hover:bg-slate-700 bg-slate-900 px-4 py-2 rounded-lg">View Archive</a>
                            <a href="#" class="hover:bg-slate-700 bg-slate-900 px-4 py-2 rounded-lg">Settings</a>
                            <a href="#" class="hover:bg-red-400 bg-red-500 px-4 py-2 rounded-lg">Log Out</a>
                        </div>
                    </a>
                    {{-- End Mobile Menu --}}
                    ...
                    <div class="flex-row gap-4 hidden md:flex lg:flex">
                        <a href="#" class="px-4 py-2 bg-blue-500 hover:bg-blue-400 rounded-xl ">Edit
                            Profile</a>
                        <a href="#" class="px-4 py-2 bg-blue-500 hover:bg-blue-400 rounded-xl">View Archive</a>
                        <a href="#" class="px-4 py-2 bg-red-500 hover:bg-red-400 rounded-xl">Log Out</a>
                        <a href="#">
        ...
        <div class="flex flex-col items-center">
            <hr class="my-4 border-gray-300 dark:border-gray-700 w-full">
            Feed
            <hr class="my-4 border-gray-300 dark:border-gray-700 w-full">
