    ...
    <div class="flex flex-col w-full px-2 md:px-10 lg:px-20 bg-slate-900 text-white gap-10">
                ...
                <div class="flex flex-row  gap-4 items-center justify-between">
                    ...
                    <a href="#" id="menu" class="block md:hidden relative">
                        ...
                        <div id="menu-content" style="z-index: 9999;"
                            ...
                            <a href="{{ route('pages.profile-setting') }}"
                                class="hover:bg-slate-700 bg-slate-900 px-4 py-2 rounded-lg">Settings</a>
        ...
        <div class="flex flex-col items-center">
            ...
            <div class="relative w-full h-20 ">
                ...
                <a class="absolute top-1/2 right-5 transform -translate-y-1/2">
            ...
            <div class="grid grid-cols-3 gap-2 md:gap-5 lg:gap-8 md:mt-4 lg:mt-8">
                <div class="">
